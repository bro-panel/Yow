...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'wishmithadineth@gmail.com', // Your Mega A/c Email Here
            password: 'wishmithadineth@gmail.com' // Your Mega A/c Password Here
        }).ready;
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of 𝐒𝐇𝐀𝐆𝐄𝐄
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join]( https://whatsapp.com/channel/0029Vb6A4FQJkK7AOqqfBM17 ) 
  

🚀 _Thanks for choosing SHAGEE MD— Let the automation begin!_ ✨`;
